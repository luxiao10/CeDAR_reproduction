...
1. Please make sure working path has been correctly set (a.k.a setting the variable main.path at beginning of code to the folder CeDAR_reproduction).
2. Please make sure all required packages have been installed and loaded
...
/analysis/real-data/blood_sle: Figure S13
/analysis/real-data/blood_smoke: Figure S14
/analysis/real-data/brain_ds: Figure S12
