...
png(paste0(data_path,'/figS_PR_',cell.num,'cells.png'),height=15, width=20, res=480,unit='in')
...
### MCC curve
png(paste0(data_path,'/figS_MCC_',cell.num,'cells.png'),height=15, width=20, res=480,unit='in')
layout(matrix(c(rep(rep(1:5,each=6),5),
                rep(rep(6:11,each=5),6),
                rep(rep(12:17,each=5),6),
                rep(rep(18:23,each=5),6)), 23, 30, byrow = TRUE), 
...
### TDR curve
png(paste0(data_path,'/figS_TDR_',cell.num,'cells.png'),height=15, width=20, res=480,unit='in')
layout(matrix(c(rep(rep(1:5,each=6),5),
                rep(rep(6:11,each=5),6),
                rep(rep(12:17,each=5),6),
                rep(rep(18:23,each=5),6)), 23, 30, byrow = TRUE), 
