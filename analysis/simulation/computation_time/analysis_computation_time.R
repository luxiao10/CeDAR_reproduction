### Table S9 computation time evaluation
### load packages
library(ROCR)
library(ggplot2)
library(ggpubr)
...
### set up path
### Please make sure main path has been set to path to CeDAR_reproduction 
...
### skip loading functions_cedar_2.0.R if you downloaded the newest cedar function
### from TOAST
